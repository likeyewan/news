...
import com.example.news.adapter.NoteAdapter;
import com.example.news.bean.Note;
import com.example.news.bean.User;
import com.example.news.service.Day_Night_Service;
import com.example.news.ui.EditActivity;
import com.example.news.ui.NewsActivity;
import com.example.news.ui.ModifyActivity;
import com.example.news.ui.WordActivity;
import com.example.news.utils.L;
import com.example.news.utils.PictureUtil;
...
public class MainActivity extends AppCompatActivity implements RecycylerViewListener, View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        HeConfig.init("HE2006301116051472", "8c4a0a2ba40a40fa98dd1457c4d4f5d1");//和风天气账户初始化
        ...
        //动态注册广播，用于更换日夜模式
        IntentFilter intentFilter = new IntentFilter("com.example.news.DAY_NIGHT_CHANGE");
        intentFilter.addCategory("com.example.news.DAY_NIGHT_CHANGE");
